...
### Comptes (approche efficace) {.smaller}
...
En calculant plusieurs densités de rayon différent et en les comparant, on peut faire ressortir des tendances locales.
Par exemple, en mesurant la densité à 500m et la densité à 250m, puis en soustrayant (ou divisant) l'une à l'autre, on montre pour chaque point le ratio entre la densité moyenne du quartier environnant et celle du voisinage proche.
